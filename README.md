...
`KenyaPoliticalEconomy_DataCleaningSample.ipynb`  
...
`ImpactEvalPS3_RegressionSample.ipynb`  
...
- SIDE ethnic group raster dataset
- MLDA.dta (provided in course materials)
- OPIS gas station price and location data (not included)  
